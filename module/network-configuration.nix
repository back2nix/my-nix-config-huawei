{
  ...
  networking = {
    ...
    extraHosts = ''
      ...
      10.0.0.1 vpn.local casino.local app.local grafana.local pyroscope.local prometheus.local postgres.local auth.local grpc.app.local grpc.casino.local redis.local livekit.local china.local grpc.china.local office.china.local
